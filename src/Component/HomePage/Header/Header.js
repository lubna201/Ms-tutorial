    ...
    return (
        <div className="row container mt-5 pt-5 d-flex align-items-center">
            <div className="col-md-4">
                ...
                <h1 className="pt-4" style={{ color: "#0dcaf0" }}>MS Tutorial</h1>
                <h2 className=" lh-base">Access 200 free online courses.Gain new skills and earn a certificate of completion</h2>
